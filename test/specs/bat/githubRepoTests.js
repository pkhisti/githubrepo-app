...
describe('Browse Github Repo App', () => {
  ...
  it('Browse Github Repo App: should load latest commit data in the modal', () => {
    browser.pause(1000);
    expect(browser.getValue("//body/div[@role='dialog']/div[@role='dialog']//div[@role='document']//ul[@class='list-group']//h4[.='12/22/2015 : Tommy Bishop']")).to.eql("12/22/2015 : Tommy Bishop");
    browser.pause(1000);
